...
class WelcomeControllerIntegrationTests {
	...
	@Test
	void testWelcomePageReturnsOk() throws Exception {
		mockMvc.perform(get("/")).andExpect(status().isOk()).andExpect(view().name("welcome"));
	}

	@Test
	void testWelcomePageRendersHtml() throws Exception {
	...
	@Test
	void testWelcomePageDefaultLocaleIsEnglish() throws Exception {
		mockMvc.perform(get("/"))
			.andExpect(status().isOk())
			.andExpect(content().string(org.hamcrest.Matchers.containsString("Welcome")));
	}
	...
	@Test
	void testWelcomePageUnsupportedLocaleFallsBackToEnglish() throws Exception {
	...
	@Test
	void testWelcomePageContainsPetImage() throws Exception {
		mockMvc.perform(get("/"))
			.andExpect(status().isOk())
			.andExpect(content().string(org.hamcrest.Matchers.containsString("/resources/images/pets.png")));
	}

	@Test
	void testWelcomePageDoesNotContainWhitelabelError() throws Exception {
		mockMvc.perform(get("/"))
			.andExpect(status().isOk())
			.andExpect(content()
				.string(org.hamcrest.Matchers.not(org.hamcrest.Matchers.containsString("Whitelabel Error Page"))));
	}
